...
xlabel('Sec');
ylabel('A');
title('Inductor current T_L = 20 Nm');
...
xlabel('Sec');
ylabel('V');
title('Inductor voltage T_L = 20 Nm');
...
xlabel('Sec)');
ylabel('V');
title('Capacitor voltage T_L = 20 Nm');
...
xlabel('Sec');
ylabel('A');
title('Capacitor current T_L = 20 Nm');
...
xlabel('Sec)');
ylabel('rad/s');
title('Angular frequency T_L = 20 Nm');
...
xlabel('Sec)');
ylabel('Nm');
title('Electric torque T_L = 20 Nm');
